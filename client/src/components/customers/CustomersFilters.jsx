                ...
                <div id="CustomersFilter-links">
                    <span className='h-full flex flex-row items-center gap-2 justify-center text-xs font-medium'>
                        <Link to="create-customer">
                            <button type="submit" className='border border-rose-500 h-fit whitespace-nowrap button text-black hover:bg-rose-800 focus:ring-4 focus:outline-none hover:text-white focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-violet-800'>Create / Edit Customer</button>
                        </Link>
