...
const GenericForm = ({
    ...
    return (
        <form className={formClass} onSubmit={handleSubmit}>
            ...
            <input 
                className={`${buttonClass} button text-white mt-10 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:bg-violet-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-violet-800`}
                type="submit" 
                value="Submit" 
            />
        </form>
